...
// configuration step. It creates a namespace called `cppbestpractices`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        cppbestpractices::cmake::project_name,
        cppbestpractices::cmake::project_version));// version string, acquired
